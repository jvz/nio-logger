...
import org.musigma.logging.appender.RandomAccessFileAppender;
...
public class RandomAccessFileAppenderBenchmark {
...
//        Layout layout = new SimpleLayout(StandardCharsets.ISO_8859_1);
        ...
        appender = new RandomAccessFileAppender(logFile, layout);
