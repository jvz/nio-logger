...
import org.musigma.logging.appender.FileOutputStreamAppender;
...
public class FileOutputStreamAppenderBenchmark {
...
//        Layout layout = new SimpleLayout(StandardCharsets.ISO_8859_1);
        ...
        appender = new FileOutputStreamAppender(logFile, layout);
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
            .include(FileOutputStreamAppenderBenchmark.class.getName())
            .warmupIterations(10)
